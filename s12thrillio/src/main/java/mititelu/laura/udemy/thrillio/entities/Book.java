...
public class Book extends Bookmark implements Shareable {
	...
	public boolean isKidFriendlyEligible() {
		...
		if(genre.toLowerCase().contains("philosophy") || genre.toLowerCase().contains("self-help")){
			return false;
		}
	...
	public String getItemData() {
		...
		builder.append("<authors>").append(Stream.of(authors).collect(Collectors.joining(","))).append("</authors>");
